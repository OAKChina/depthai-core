...
class CameraControl : public Buffer {
   ...
   public:
     ...
     */
    CameraControl& setControl(std::string control, std::string value);
     ...
     */
    CameraControl& setControl(std::string control, int value);
     ...
     */
    CameraControl& setControl(std::string control, float value);
